"""pi-agent runtime using a Node.js runner (cross-runtime bridge)."""
...
from .compat import AgentResult


class PiAgentBridgeExecutor:
    def __init__(
        self,
        ref: str,
...
def create_pi_agent_bridge_executor(
    *,
    ref: str,
    config: Optional[Dict[str, Any]],
    config_dir: str,
    ...
    if not ref:
        raise ValueError("pi-agent profile requires ref")
    ...
    cwd = config.get("cwd") or settings.get("cwd") or config_dir
