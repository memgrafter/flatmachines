...
- history dir: `$MK42_HOME/history` (defaults to `~/.agents/mk42/history`)
...
- Older turns remain searchable from `TOOL_USE_DISCORD_HISTORY_DIR` (defaults to `$MK42_HOME/history`).
